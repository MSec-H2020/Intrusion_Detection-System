...
Download Åginstaller.shÅh file onto your Openblocks IoT gateway device and execute as follows:  
...
If command results in only Åggrep suricataÅh process, then use ./start_ips.sh command to start the /var/run/suricata_ips.pid process. 
